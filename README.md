...
| POST        | /api/plans                      |                                              | 201            | 500           | Creates a new plan                                                                                   |
| PUT         | /api/plans/:id                  |                                              | 200            | 500           | Updates the plan                                                                                     |
| DELETE      | /api/plans/:id                  |                                              | 200            | 500           | Deletes the plan                                                                                     |
| GET         | /api/shopping-list/user/:userId |                                              | 200            | 500           | Gets a users' total shopping list (the one on dashboard)                                             |
| GET         | /api/shopping-list/plan/:planId |                                              | 200            | 500           | Gets a shopping list, connected to specific plan                                                     |
| PATCH       | /api/shopping-list/:id          |                                              | 200            | 500           | Updates items in shopping list                                                                       |
